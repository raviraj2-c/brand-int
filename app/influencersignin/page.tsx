...
export default function Signin() {
  ...
  <h1 className="text-lg font-bold text-[rgb(43 38 51)] tracking-wider">SOCIAL STRATIX</h1>
          ...
          <form className="space-y-3" suppressHydrationWarning>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute cursor-pointer top-2.5 right-3 text-gray-500 transition-colors hover:text-gray-700"
                suppressHydrationWarning
              >
            ...
            <button
              ...
              className="w-full cursor-pointer text-white font-bold py-2 rounded-full text-sm transition-colors hover:brightness-110"
              suppressHydrationWarning
            >
              SIGN UP
            </button>
          ...
          <button
            type="button"
            onClick={() => router.push('/')}
            className="login-button cursor-pointer font-bold w-full bg-white py-2 rounded-full border text-sm transition-colors hover:bg-gray-50"
            suppressHydrationWarning
          >
            LOGIN
          </button>
