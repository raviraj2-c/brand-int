        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-[420px]">
          ...
          <button 
           type="button"
              ...
              className="flex cursor-pointer items-center gap-2 mb-4 transition-colors hover:bg-gray-100 rounded-lg p-1"
          >
          ...
          <div className="flex items-start gap-4">
            ...
            <div
              ...
              className="w-36 h-36 cursor-pointer rounded-full border-2 border-dashed flex items-center justify-center text-sm cursor-pointer relative overflow-hidden transition-colors hover:bg-gray-50 cursor"
              style={{
                borderColor: purple
              }}
            >
