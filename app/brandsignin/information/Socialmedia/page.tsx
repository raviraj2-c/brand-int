      ...
      <div className="flex justify-center items-center flex-1 bg-[#f9f6f4]">
        <div className="w-[400px] p-6 bg-white shadow-md rounded-lg">
          ...
          <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2 mb-4">
            ...
            className="bg-gray-200 p-2 cursor-pointer rounded-lg inline-flex items-center justify-center">
          ...
          <div className="space-y-3">
            ...
            <button
             type="button"
              onClick={() => router.push('/brandsignin/information/skill')}
            ...
            type="button"
              onClick={() => router.push('/brandsignin/information/skill')}
              style={{ color: purple }}
              className="w-full cursor-pointer text-center text-sm mt-2"
            >
              SKIP
            </button>
          </div>
