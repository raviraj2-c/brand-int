...
export default function Signin() {
  ...
  <h1 className="text-lg font-bold text-[rgb(43 38 51)] tracking-wider">SOCIAL STRATIX</h1>
          ...
          <form className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute cursor-pointer top-2.5 right-3 text-gray-500"
              >
            ...
            onClick={() => router.push('/brandsignin/information/verify')}
              ...
              className="w-full cursor-pointer text-white font-bold py-1.5 rounded-full text-sm"
            >
              SIGN UP
            </button>
          </form>
          ...
          <button
            type="button"
            onClick={() => router.push('/')}
            className="login-button cursor-pointer font-bold w-full bg-white py-1.5 rounded-full border text-sm"
          >
            LOGIN
          </button>
