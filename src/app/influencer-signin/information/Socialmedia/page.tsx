...
export default function LinkSocialMediaAccount() {
  ...
  useEffect(() => {
    router.prefetch('/influencer-signin/information/photo');
        ...
        <div className="w-[400px] p-6 bg-white shadow-md rounded-lg">
          ...
          <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2 mb-4">
            <button 
              ...
              className="bg-gray-200 p-2 rounded-lg inline-flex items-center justify-center transition-colors hover:bg-gray-300"
            >
          ...
          <div className="space-y-3">
            ...
            <button
              type="button"
              onClick={() => router.push('/influencer-signin/information/photo')}
            ...
            <button
              ...
              onClick={() => router.push('/influencer-signin/information/photo')}
              style={{ color: purple }}
              className="w-full text-center text-sm mt-2 transition-colors hover:bg-purple-50"
            >
              SKIP
            </button>
          </div>
