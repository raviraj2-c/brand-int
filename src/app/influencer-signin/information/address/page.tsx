...
<div className="flex mb-4 mt-1">
  {[...Array(5)].map((_, index) => (
    <div
      ...
      style={{
        backgroundColor: index < currentStep ? purple : '#e5e7eb' // gray-300
      }}
    ></div>
  ))}
</div>
          ...
          <div className="flex items-center mb-4 gap-2">
            <div className="relative">
              <button
                ...
                className="w-12 h-10 border rounded-md flex items-center justify-center bg-white"
            ...
            <input
              ...
              className="flex-1 px-4 py-2 outline-none text-gray-700 bg-white rounded-md placeholder-black"
              style={{ border: `1px solid ${purple}` }}
            />
          </div>
          ...
          <input
            type="text"
            placeholder="State"
            className="w-full mb-4 p-2 rounded-md placeholder-black"
            style={{ border: `1px solid ${purple}` }}
          />
          ...
          <textarea
            ...
            className="w-full p-2 rounded-md placeholder-black"
            style={{ border: `1px solid ${purple}` }}
          ></textarea>
