...
import { Check, Pencil, ExternalLink, Flag, Copy} from "lucide-react";
const Edit = () => {
  return (
    <>
      <Navbarall />
...
<hr className='mt-3 w-2xl' />
  ...
  style={{
    ...
    height: '40%', // or a fixed height like '500px'
  }}
> 
      ...
      <div className="flex justify-between items-center">
        ...
        className=" text-[rgba(120,60,145,1)] px-3 py-1 rounded-full border text-xs font-semibold">CLOSE CAMPAIGN</button>
        <div 
  className="border rounded-lg w-8 flex justify-center items-center" 
  style={{ borderColor: 'rgba(120,60,145,1)' }}
>
  <button className="text-[rgba(120,60,145,1)] font-bold text-md">&#8942;</button>
</div>
...
<div className="flex justify-between text-sm mt-1">
  ...
  <span className="font-bold">₹0.25</span>
      ...
      <a href="#" className="text-[rgba(120,60,145,1)] text-xs  flex items-center gap-1">
  ...
  />
  <Copy
    className="w-4 h-4 text-gray-500 cursor-pointer absolute right-3 top-1/2 transform -translate-y-1/2"
  />
</div>
      </div>
    </div>
