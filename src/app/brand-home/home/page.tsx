            ...
            <section className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {filteredInfluencers.length === 0 ? (
                ...
                filteredInfluencers.map((influencer, idx) => (
                  ...
                  >
                    <button type="button" onClick={() => router.push('/brand-home/home/brand-page')}>
                      ...
                      <div className="pt-1 px-2 pb-1 flex flex-col justify-between flex-1">
                        ...
                        <p className="text-[0.65rem] text-gray-500 mb-1 line-clamp-2">
                          {influencer.tags.join(', ')}
                        </p>

                        <div className="flex flex-wrap gap-1 text-[0.65rem] font-medium">
                          {influencer.socials.map((social, i) => {
                            const Icon = iconMap[social.icon] || (() => null);
                            return (
                              <div
                                key={i}
                                className="flex items-center border gap-1 px-1 py-0.5 rounded-sm w-1/5"
                                style={{
